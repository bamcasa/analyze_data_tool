...
def find_curveline(a):
    ...
    for i in range(len(P_x) - 1):
        ax3.plot(L_x[i], L_y[i], linewidth = 1.5, color = "#ff0000")
    ax3.set_zorder(ax2.get_zorder() - 10)
